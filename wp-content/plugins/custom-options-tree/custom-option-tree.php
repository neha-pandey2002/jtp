 ...
 ?>
	<div class="wrap">
		...
		<h2 class="nav-tab-wrapper"> 
                <a href="?page=edit-custom-option-tree&tab=tab_header" class="nav-tab <?php echo $active_tab == 'tab_header' ? 'nav-tab-active' : ''; ?>">Header Section</a>  
                <a href="?page=edit-custom-option-tree&tab=tab_footer" class="nav-tab <?php echo $active_tab == 'tab_footer' ? 'nav-tab-active' : ''; ?>">Footer Section</a>  
                <a href="?page=edit-custom-option-tree&tab=tab_social" class="nav-tab <?php echo $active_tab == 'tab_social' ? 'nav-tab-active' : ''; ?>">Social Media Section</a>  
                <a href="?page=edit-custom-option-tree&tab=tab_global" class="nav-tab <?php echo $active_tab == 'tab_global' ? 'nav-tab-active' : ''; ?>">Global Section</a>
        </h2>
...
?>
	<p><input class="text-box" type="text" placeholder="&copy; 2018 Wordpress" name="cot_options[copy_right]" value="<?php echo esc_attr($cot_copyright); ?>">
